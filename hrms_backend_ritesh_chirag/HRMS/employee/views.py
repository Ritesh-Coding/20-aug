...
from .serializers import LatestActivitiesSerializer,EmployeeRelationSerializer,DocumentsSerializer,AttendanceSerializer,LogsSerializer,AllLogsSerializer,EmployeeDailyActivitiesSerializer,EmployeeProfileSerializer,DocumentsUpdateSerializer,RelationsUpdateSerializer,NotificationSerializer,UpdateAttendanceSerializer
...
#     permission_classes = [permissions.AllowAny]
#     queryset = Employee.objects.all()
#     serializer_class=HotlineEmployeesSerializer
#     def get_permissions(self):
#         if self.request.method in ["POST","PUT","PATCH","DELETE"]:
#             self.permission_classes = [permissions.IsAdminUser]
#         else:
